...
UpdateChannel.prototype.broadcast = function(updatedModel){
  // broadcast message for all the sockets listening
  // on this channel id
  var listeners = listenersByModelId[updatedModel.id];
  console.log('broadcasting update', updatedModel.id, listeners);
  var self = this;
...
UpdateChannel.prototype.addListener = function(modelId, clientSocket){
  ...
  console.log('adding listener to update channel');
