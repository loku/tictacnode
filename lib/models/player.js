var _ = require('underscore'),
    ...
    realtime = require('../realtime-model');
  ...
  save: function(attrs, opts) {
    ...
    if (this.get('id') == null){
      ...
      if (activePlayer){
        ...
        // broadcast the instance change
        console.log('trigger instanceChange event');
        Player.trigger('instanceChange', activePlayer);
      } else {
...
// mixin the realtime notifications
realtime(Player);