...
var GameView = Backbone.View.extend({
  ...
  initialize:function(){
    ...
    this.xPlayer.on('change', function(updatedModel){
      $(self.el).find('#xPlayer').text(updatedModel.get('name'));
    });

    this.oPlayer.on('change', function(updatedModel){
     $(self.el).find('#oPlayer').text(updatedModel.get('name'));
    });
